...
public class StepsCurrency {
	...
	Request request = new Request.Builder().url("https://exchangerate-api.p.rapidapi.com/rapid/latest/EUR").get()
			.addHeader("x-rapidapi-key", "ff143ff2msh2f1f7c558b7c62dp13f2b0jsnd361f3ac8348")
			.addHeader("x-rapidapi-host", "exchangerate-api.p.rapidapi.com").build();

	@When("I dont have any parameters passed")
	public void i_dont_have_any_parameters_passed(List<String> params) {
	...
	public void currency_Conversion_is_returned() {
		System.out.println("Currency In Capital Letters");
	}
	...
	public void i_Input_A_non_numeric_amount(List<String> params) {
		MainClass.main(params.toArray(new String[params.size()]));
	}
